...
Introduces incomparable Product Catalog demonstration. Just use it to better lean about all advantages.

== Description ==

* [Wordpress Plugin](https://huge-it.com/product-catalog/)
* [Demo](https://huge-it.com/wordpress-plugins-product-catalog-demo/)
* [FAQ](https://huge-it.com/wordpress-product-catalog-faq/)
* [User Manual](https://huge-it.com/wordpress-product-catalog-user-manual/)
* [Support](https://wordpress.org/support/plugin/product-catalog)
* [Forum](https://wordpress.org/support/plugin/product-catalog)

https://www.youtube.com/watch?v=OapAJ5lHUcU

Let us introduce our Huge-IT incomparable plugin. To begin with, why do we need this plugin and what are the advantages.
...
Catalog may also be customized according to your taste, to allow a detailed understanding of the product. In addition, each product may be associated with the images as single and multiple.

Customers are provided with the ability of rate the products, and writing feedback about products shown, as well as writing reviews which will show up for each product.

License provides you with a high level of customization in relation to almost all aspects: from the background color and size of the text inside the cell of the product to the number of products in the series and the number of comments on the product page.
...
General Options for pro users you can find on the left panel under. There are:

Besides basic plugin we have additional plugin to it, called Related Products.

Related Products plugin works only in addition to plugin, and will not work without it.

The plugin is made to bring all related products in the certain product page. For example: if you are interested in “watches” and have entered to the page of your prefered watch, under it you will see another watches that are offered.

Pro version Related Products provides you with different customization on related products’ block. More detailed about the options you can learn from User Manual Related Products plugin.

### Catalogs: from here you can add products. Admin page includes:
...
**Related Products ( works only with Plugin)**. this tool has as pro and free versions, and helps you to demonstrate related products while choosing some category. You can learn more about pro version In user manual of Related Products plugin.
...
*  Block Toggle Up-Down. The compact solution for your shop page. The view will demonstrate the main image in similar boxes with title, and little arrow next to it, as you press the arrow opens vertical tape, which consists of additional images, description and other parameters about product, and “View Product” button. Pressing on that button you will get tomain page. All images open with Lightbox.

*  Full-Height Blocks. You definitely have seen e-commerce websites with such design. Its opened vertical tape, with large main image, additional images, text, information and “View Product” button. Pressing on that button you will get to main page.  All images can be opened with Lightbox.

*  Content Popup. In closed position it is fixed boxes with cover/mail image and title, as you click on image, opens popup with larger main and additional images in it, title, description and other information about the product next to it, so its gives fastness for your store as shop will not open new page but big popup with main information, also popup has “View Product” button. Pressing on that button you will get to main page.

*  Full-With Blocks. Main image with tiny additional images under it, all of them can be opened with Lightbox. Next to the images you can find title, description, product information and  “View Product” button. Pressing on that button you will get to main page.

*  Content Slider.Slider with main image with tiny additional images under it, all of them can be opened with Lightbox. Next to the images you can find title, description, product information and  “View Product” button. Pressing on that button you will get to main page. Slide the content manually by pressing on arrows. You also may use it in your shop with another view as widget or advertisement for another category of store.

**Unlimited Amount of Catalogs and Products**

Add unlimited number of products in a single catalog. And as you created a number of catalogs, you can add as many shortcodes in your website, as you need.
...
Customer decided to make a purchase or ask some question in, with useful “Contact Seller” button he/she can fill the special form and submit the message.
...
Admin panel is full of user-friendly features, from there you can choose styles, add millions of parameters, change the order of the products and many-many other things that will make creating process easy and enjoyable.


Upgrade to [Pro](https://huge-it.com/product-catalog) to Customizable Styles and Colors.
...
>
>[Content Popup Demo](https://huge-it.com/wordpress-product-catalog-demo-3-content-popup/#plugin_demo_wrapper)
>
>[Full-Height Blocks Demo](https://huge-it.com/wordpress-product-catalog-demo-4-full-height-blocks/#plugin_demo_wrapper)
>
>[Content Slider Demo](https://huge-it.com/wordpress-product-catalog-demo-5-content-slider/#plugin_demo_wrapper)
...
1.  [WordPress](https://huge-it.com/wordpress-plugins-product-catalog-demo/#plugin_demo_wrapper) - Blocks Toggle Up/Down
12.  [WordPress](https://huge-it.com/wordpress-product-catalog-demo-3-content-popup/#plugin_demo_wrapper) -  Content Popup
13.  [WordPress](https://huge-it.com/wordpress-product-catalog-demo-2-full-width-block/#plugin_demo_wrapper) - Full-Width Block
13.  [WordPress](https://huge-it.com/wordpress-product-catalog-demo-5-content-slider/#plugin_demo_wrapper) - Content Slider
14.  [WordPress](https://huge-it.com/wordpress-plugins-product-catalog-demo/#plugin_demo_wrapper) - Blocks Toggle Up/Down
15.  [WordPress](https://huge-it.com/wordpress-product-catalog-demo-3-content-popup/#plugin_demo_wrapper) - Content Popup
16.  [WordPress](https://huge-it.com/wordpress-product-catalog-demo-4-full-height-blocks/#plugin_demo_wrapper) - Full-Height Blocks
2.  [WordPress](https://huge-it.com/product-catalog/) - Single page 
22.  [WordPress](https://huge-it.com/product-catalog/) - Single page 
23.  [WordPress](https://huge-it.com/product-catalog/) - Single page 
5.  [WordPress](https://huge-it.com/product-catalog/) - admin page 
52.  [WordPress](https://huge-it.com/product-catalog/) - admin page 
53.  [WordPress](https://huge-it.com/product-catalog/) - admin page 
54.  [WordPress](https://huge-it.com/product-catalog/) - admin page 
55.  [WordPress](https://huge-it.com/product-catalog/) - admin page 
56.  [WordPress](https://huge-it.com/product-catalog/) - admin page 
57.  [WordPress](https://huge-it.com/product-catalog/) - admin page 
58.  [WordPress](https://huge-it.com/product-catalog/) - admin page 
59.  [WordPress](https://huge-it.com/product-catalog/) - admin page 
...
= I want to click on image main image and be directed to my product page, is it possible? =

* If something is not provided in plugin, this is additional customization, for that just contact info@huge-it.com, ask for the conditions and our developers will help you with it.
...
= Have purchased pro version plugin but still get the announcement to buy the commercial version to change settings. What to do? =
...
After installation of pro version, in pro options all your changes will be saved! If you still see “free version” notification after installation.
...
* Unfortunately  the plugin is demonstration and not a shopping plugin, so it doesn't have the payment button ability, but you always may add some external link made with HTML into the description of the product, or order additional button customization to our support team.
...
= 1.5.0 =
**We make additional bug fixes,  edited code structure of plugin in order to meet all WordPress standards fully. There are still points we will fix during the next weeks, as the plugin is rather big and the code is pretty much messed up, so please, let us know if you catch a bug or any issue after the update at info@huge-it.com**
...
Description. Give description about the products 
...
Select Theme. Choose one of the views from 5 available views 
Parameters. This area is made to add or change the additional parameters
Thumbnail. You can upload cover image.
...
* Show Description. Tick to show the description or not 
* Description Font Size. Choose size of description 
...
* Element Width. Choose width size for elements of the product
* Element Height. Choose height for elements of the products
...
* Show Description. Select to show the description or not
* Description Font Size. Choose size of description
* Description Font Color. Choose color for description font
